...
# Set compiler paths
if (PLATFORM_WINDOWS)
    set(CMAKE_C_COMPILER ${COMPILER_PREFIX}C51.exe)
    set(CMAKE_ASM_COMPILER ${COMPILER_PREFIX}A51.exe)

    # Set other tools
    set(OBJSIZE ${COMPILER_PREFIX}arm-none-eabi-size.exe)
    set(OBJCOPY ${COMPILER_PREFIX}arm-none-eabi-objcopy.exe)
    set(OBJDUMP ${COMPILER_PREFIX}arm-none-eabi-objdump.exe)
    set(DEBUGGER ${COMPILER_PREFIX}arm-none-eabi-gdb.exe)
